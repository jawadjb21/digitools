...
const Navbar = ({ navLinksPromise }) => {
    ...
    return (
        <div className='flex justify-between items-center mx-auto container'>
            ...
            <h2 className='bg-linear-to-r from-[#4F39F6] to-[#627382] bg-clip-text inline-block text-transparent font-bold text-2xl md:text-4xl'>DigiTools</h2>
            ...
            <button className='btn btn-ghost md:hidden'><IoIosCart /></button>
        </div>
    );
};
